...
visIgraph(
  ...
  visLegend(
    ...
    zoom=FALSE
     ...
     visGroups(groupname="Tablas_Teradata", color="chocolate2", shape="box") %>% 
      visGroups(groupname="Tablas_Exadata", color="red3", shape="box") %>% 
     visGroups(groupname="Tablas_BDA", color="palegreen3", shape="box") %>% 
