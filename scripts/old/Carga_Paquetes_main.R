...
#Lib_file()
#  xfuente<-"/LIBS/teradatasql_17.10.0.1.tar"
#install.packages(paste0(rutainicial,xfuente),repos = NULL, type = "source",logical.return=TRUE, warn.conflicts = FALSE)

install.packages("~/Documents/R/Linaje/LIB/teradatasql_17.10.0.1.tar", repos = NULL,type="source")
install.packages("~/Documents/R/Linaje/LIB/crayon_1.4.2.tar", repos = NULL,type="source")


install.packages('tdplyr',repos=c('https://teradata-download.s3.amazonaws.com','https://cloud.r-project.org'))
#install.packages("~/Documents/R/Linaje/LIB/ROracle_1.3.1.gz", repos = NULL,type="source")
install.packages("DBI")
#load_package(paste0(rutainicial,xfuente))

libraries("teradatasql","tdplyr","crayon")
#devtoolls::install_github("jakesherman/easypackages")


install.packages(repos=c('https://teradata-download.s3.amazonaws.com','https://cloud.r-project.org'))
install.packages('tdplyr',repos=c('https://teradata-download.s3.amazonaws.com','https://cloud.r-project.org'))
